...
class stats_page_load_test extends WebTestCase {
    ...
    function testSeasonTenLoad() {
        ...
        $this->assertText('103 56 159 35 2.94 1.60 4.54 32.19 9 27 8 19 77.14', 'The text was not found.');
    }
    ...
    function testSeasonTenGoalieLoad() {
        ...
        $this->assertText('282 36 7.83 1350 0.209 23 13 10 63.89 0 0 4 4', 'The text was not found.');
    }  
