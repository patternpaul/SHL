...
class RecordStoreTest extends \App\Infrastructure\Test\TestCaseCore
{
    ...
    public function test_will_clear_out_record_from_player_who_no_longer_has_it()
    {
        $season = 1;
        $gameCount = 250;
        $playoff = 0;
        ...
        $jaquesRecords = $this->recordStore->getPlayerRecords($this->jacquesAuger);
        $this->assertTrue(!isset($jaquesRecords[\App\Listeners\Records\AssistClub::BASE_KEY.':0250']));
    }
